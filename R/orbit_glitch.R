...
#' @export
#'
orbit_glitch <- function(seed_probs = c(0, 0.8, 0.2, 0), glitch_type = "spike", pareto2_prob = c(0.2, 0.8),
                             glitch_params = list(num_glitches = 17, glitch_r_min = 0.7, glitch_r_max = 1.2,
